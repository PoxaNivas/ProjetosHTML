...
$('section#Depoimentos').waypoint(function(direcao){
    if (direcao == 'down'){
        $('div#testemunhos ul:eq(0)').addClass('Transicao-Depoimentos')
        $('div#testemunhos ul:eq(1)').addClass('Transicao-Depoimentos')
        $('div#testemunhos ul:eq(2)').addClass('Transicao-Depoimentos')
    }
